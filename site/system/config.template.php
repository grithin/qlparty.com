...
///path to view folder (in case you want to use some common templates folder)
$config['viewFolder'] = '::instanceFolder::view/';
///path to template folder (in case you want to use some common templates folder)
$config['templateFolder'] = '::viewFolder::templates/';
///path to template folder (in case you want to use some common templates folder)
...
$config['autoloadIncludes'] = array(
		...
		'::systemFolder::view/utilities/general/',
		'::systemFolder::view/utilities/system/',
		'::instanceFolder::view/utilities/general/',
		'::instanceFolder::view/utilities/system/',
		'::instanceFolder::view/utilities/instance/',
		'::instanceFolder::view/utilities/section/'
	);
...
/**This variable will cause the autoloader to do some interesting things
	- check every folder in the sections folder up to and not including the section folder.  So, if the page tokens were blogs,cars,chevy, the autloader would check:
		...
		- instance/view/utilities/blog/cars/chevy
		- instance/view/utilities/blog/cars
		- instance/view/utilities/blog/
...
#$config['aliasesFiles'] = '::instanceFolder::view/aliases.php';
//+	}
...
$config['timezone'] = 'UTC';
//input taken from and output given to user.  Don't use if timezzone entered by user (b/c CRUDModel will change on filter to datetime)
